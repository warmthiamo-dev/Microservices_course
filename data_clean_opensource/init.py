...
cfg = Config(server_id=env.get("isdp.instance-id"), device_ip=env.get("isdp.instance-ip") or env.get("isdp.ip") or env.get("isdp.instance-id"))

if __name__ == '__main__':
    print("project: ", '3123005142_data_clean')
    print("启动参数: ", envStr)
